  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 bg-gradient-to-r from-[#1E40AF] to-[#1E3A8A] text-white flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <p className="text-xl md:text-2xl text-blue-100">
            At Koh Thmey Technology, we believe everyone can do great thing, we offer you opportunity to show and perform with our senior guides.

           <br /> Opportunities don’t happen, you create them…!
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-gray-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value) => (
              <Card
                key={value.title}
                className="p-6 text-center shadow-md hover:shadow-lg transition-shadow"
              >
                <img 
                  src={value.icon} 
                  alt={value.title} 
     ...
     {/* Job Listings */}
      ...
      {/* CTA Banner */}
      <section
        className="py-20 px-4 md:px-8 lg:px-16 bg-cover bg-center relative text-center"
        style={{
          backgroundImage:
